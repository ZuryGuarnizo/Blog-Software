...
class ModernBlogApp:
    def __init__(self):
        ...
        self.frames = {}
        for F in (HomeFrame, WritePostFrame, MyPostsFrame):  # Añadí MyPostsFrame
    ...
    def create_navbar(self):
        ...
        buttons = [
            ...
            ("Mis Publicaciones", lambda: self.show_frame("MyPostsFrame")),
        ]
...
class MyPostsFrame(ttk.Frame):
    ...
    def refresh_my_posts(self):
        """Actualizar y mostrar solo los posts del usuario."""
        for widget in self.posts_container.winfo_children():
            widget.destroy()
